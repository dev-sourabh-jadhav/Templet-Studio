...
<head>
    ...
    <meta name="description" content="Templet Studio">
...
<body>
    ...
    <div class="search-box bg-dark position-relative">
        <div class="search-wrap">
            ...
            <form id="search-form" class="text-lg-center text-md-left pt-3" action="login" method="get">
    ...
    <!-- Login -->
    <header id="header" class="site-header bg-gradient text-white shadow-sm">
        <nav id="header-nav" class="navbar navbar-expand-lg">
            <div class="container-lg d-flex align-items-center justify-content-between position-relative">

                <!-- Left Side: Logo -->
                <a class="navbar-brand d-flex align-items-center" href="login">
                    <img src="assets/img/logo.png" class="logo me-2" alt="logo" width="120">
                </a>

                <!-- Center: Name -->
                <div class="position-absolute start-50 translate-middle-x">
                    <span class="navbar-text fw-bold fs-3 text-uppercase text-light">Templet Studio</span>
                </div>
                ...
                <div class="offcanvas offcanvas-end bg-dark text-white" tabindex="-1" id="bdNavbar">
                    <div class="offcanvas-header px-4 pb-0">
                        <a class="navbar-brand ps-3" href="login">
                            <img src="assets/img/logo.png" class="logo" alt="logo" width="120"
                                height="100">
                        </a>
                        <button type="button" class="btn-close btn-close-white p-3" data-bs-dismiss="offcanvas"
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar"
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 text-white btn btn-outline-light rounded-pill px-4"
                                    href="/login">Login</a>
                            </li>
                            <li class="nav-item">
    ...
    <section id="intro" class="position-relative mt-5">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="btn-wrap">
                            ...
                            <button id="getdiscount"
                                class="btn btn-black btn-medium text-uppercase hvr-sweep-to-right"
                                data-bs-toggle="modal" data-bs-target="#getDiscountModal">
                                Email me
                            </button>
                        </div>
                    </div>
    ...
    {{-- discount form --}}
    <div class="modal fade" id="getDiscountModal" tabindex="-1" aria-labelledby="getDiscountModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="getDiscountModalLabel">Enter Your Email</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="getDiscountForm">
                        <div class="mb-3">
    ...
    <section id="featured-products" class="product-store">
        <div class="container-md">
            <div class="display-header d-flex align-items-center justify-content-between">
                <h2 class="section-title text-uppercase">Gate Design</h2>
                <div class="btn-right">
                    <a href="/login" class="d-inline-block text-uppercase text-hover fw-bold">View all</a>
                </div>
            </div>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
                    <div class="col mb-4">
                        <div class="product-card position-relative">
                            <div class="card-img">
                                <img src="assets/img/standi.jpg" alt="product-item" class="product-image img-fluid">
                    ...
                    <div class="col mb-4">
                        <div class="product-card position-relative">
                            <div class="card-img">
                                <img src="assets/img/standi1.jpg" alt="product-item" class="product-image img-fluid">
                                <div class="cart-concern position-absolute d-flex justify-content-center">
                                    <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                            data-bs-target="#modallong">
                    ...
                    <div class="col mb-4">
                        <div class="product-card position-relative">
                            <div class="card-img">
                                <img src="assets/img/standi3.jpg" alt="product-item" class="product-image img-fluid">
                                <div class="cart-concern position-absolute d-flex justify-content-center">
                                    <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                            data-bs-target="#modallong">
                    ...
                    <div class="col mb-4">
                        <div class="product-card position-relative">
                            <div class="card-img">
                                <img src="assets/img/standi8.jpeg" alt="product-item"
                    ...
                    <div class="col mb-4">
                        <div class="product-card position-relative">
                            <div class="card-img">
                                <img src="assets/img/standi6.jpg" alt="product-item" class="product-image img-fluid">
                                <div class="cart-concern position-absolute d-flex justify-content-center">
                                    <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal"
                                            data-bs-target="#modallong">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-4">
                    <div class="collection-card card border-0 d-flex flex-row align-items-end jarallax-keep-img">
                        <img src="assets/img/maharaj.jpg" alt="product-item"
                        ...
                        <div class="card-detail p-3 m-3 p-lg-5 m-lg-5">
                            ...
                            <a href="login" class="text-uppercase mt-3 d-inline-block text-hover fw-bold">Shop
                                Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="collection-card card border-0 d-flex flex-row jarallax-keep-img">
                        <img src="assets/img/maharaj1.jpg" alt="product-item"
                            class="border-rounded-10 img-fluid jarallax-img">
    ...
    <section id="latest-products" class="product-store py-2 my-2 py-md-5 my-md-5 pt-0">
        <div class="container-md">
            <div class="display-header d-flex align-items-center justify-content-between">
                <h2 class="section-title text-uppercase">Trending Images</h2>
                <div class="btn-right">
                    <a href="/login" class="d-inline-block text-uppercase text-hover fw-bold">View all</a>
                </div>
            </div>

            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5" id="product-list">
    ...
    <footer id="footer" class="py-5 border-top">
        <div class="container-lg">
            <div class="row">
                <div class="col-lg-2 pb-3"></div> <!-- Empty column for spacing -->

                <div class="col-lg-4 pb-3 text-center"> <!-- Centered Login & Register -->
                    <div class="footer-menu">
                        <h5 class="widget-title pb-2">Account</h5>
                    ...
                    <div class="footer-menu">
                        ...
                        <div class="footer-contact-text">
                            ...
                            <span class="text-hover fw-bold light-border">
                                <a href="mailto:templatesstudio71@gmail.com">templatesstudio71@gmail.com</a>
                            </span>
                        </div>
                    </div>
                </div>

                <div class="col-lg-2 pb-3"></div>
            </div>
        </div>
    </footer>
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(response) {
                    let productsHtml = "";
                    let images = response.categories.flatMap(cat => cat.images).slice(0,
                        5); // Take first 5 images
                    ...
                    <div class="col mb-4 mt-4">
                        <div class="product-card position-relative">
                            <div class="card-img">
                                <img src="${image.image_url}" alt="product-item" class="product-image img-fluid">
